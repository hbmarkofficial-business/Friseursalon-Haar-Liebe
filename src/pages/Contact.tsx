...
const Contact = () => {
  return (
    <>
      <Helmet>
        <title>Kontakt & Termin | Patrizia Blumetti Beautyful Hair</title>
        <meta 
          name="description" 
          content="Kontaktieren Sie Patrizia Blumetti Beautyful Hair in Bergisch Gladbach. Vereinbaren Sie Ihren Termin über unseren Chatbot oder rufen Sie uns an." 
        />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "address": {
              "@type": "PostalAddress",
              "streetAddress": "Im Schloßpark 19",
            ...
            "sameAs": [
              "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d160414.04901589715!2d6.637870378125007!3d51.08134204099815!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47bed7d424b1c175%3A0xb1b92f6df751d703!2sFriseursalon%20Haar-Liebe!5e0!3m2!1sde!2sde!4v1770847769983!5m2!1sde!2sde",
              ...
              <AnimateOnScroll animation="slide-right" className="order-2 lg:order-2">
                <div className="space-y-8">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <ul className="text-muted-foreground space-y-1 text-sm">
                          <li>Di,Do,Fr: 9:00 - 18:00</li>
                          <li>Mo,Mi,Sa,So: Geschlossen</li>
                        </ul>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="aspect-video rounded-sm overflow-hidden border border-border mt-8">
                    <iframe
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d160414.04901589715!2d6.637870378125007!3d51.08134204099815!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47bed7d424b1c175%3A0xb1b92f6df751d703!2sFriseursalon%20Haar-Liebe!5e0!3m2!1sde!2sde!4v1770847769983!5m2!1sde!2sde"
                      width="100%"
                      height="100%"
                      ...
                      title="Standort Patrizia Blumetti Beautyful Hair"
                    />
                  </div>
                </div>
              </AnimateOnScroll>
